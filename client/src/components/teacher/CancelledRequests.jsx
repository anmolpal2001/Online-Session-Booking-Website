            ...
            <div className="mx-auto max-w-screen-3xl px-4">
              <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div className="overflow-x-auto overflow-y-auto h-screen">
                  <table className="w-full lg:text-center text-sm text-left text-gray-500 dark:text-gray-400 overflow-y-scroll">
                        ...
                        {cancelledSessions.map((session) => (
                          ...
                          >
                            <td className="px-4 py-3">
                              {session.student.accountDetails.fullname}
                            </td>
                            <td className="px-4 py-3">
