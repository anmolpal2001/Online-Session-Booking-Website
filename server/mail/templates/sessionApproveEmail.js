...
const bookedSessionLink = `http://localhost:5173/student/booked-sessions`;

const sessionApproveEmail = (
  studentName,
  teacherEmail,
  teacherName,
  sessionDate,
  ...
  return `<!DOCTYPE html>
    ...
    <body>
        <div class="container">
            <h1>Knowledge Hub</h1>
            <div class="message">Session Confirmation Mail</div>
            <div class="body">
                <p>Dear ${studentName},</p>
                <p>Your session request has been approved.  
                </p>
                ...
                <p> Go to <a href=${bookedSessionLink}>Knowledge Hub</a> to review the request.</p>
